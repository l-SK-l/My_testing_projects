...
# Тесты
Описывается порядок тестирования и на что нужно отдельно обратить внимание.
...
# Отчёт
Все тесты должна быть зафиксированы в Отчёте.
...
В Результаты заносятся более подробная информация о каждом теста, а именно: 
- Присутствует ссылка на дашборд Grafana, отфильтрованная по времени теста
- Присутствует скриншот панели "В отчет", где отражена общая информация о результатах теста
- Присутствует скриншоты из командной строки системы с выводом диагностических команд опредеённых частей системы.
