...
# Схема стенда
![DUT](https://github.com/l-SK-l/My_testing_projects/blob/main/VPN%20remote%20access%20(RU)/assets/VPN.png)
...
Для Нагрузочных машин и Веб сервера из основных: Утилизация процессора, оперативной памяти, сетевых интерфейсов, а также количество активных соединений и воркеров на веб сервере и их состояние.
